<style>
	body {
		...
		padding: 2rem;
		background: 
			url('https://your-top-image-url.jpg') top center no-repeat, /* Top image */
			url('https://your-bottom-image-url.jpg') bottom center no-repeat, /* Bottom image */
			url('https://your-middle-image-url.jpg') center repeat-y; /* Middle image */
