<style>
	body {
		...
		padding: 2rem;
		background: 
			url('https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/refs/heads/main/templates/campaign-details/images/page-top.png') top center no-repeat, /* Top image */
			url('https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/refs/heads/main/templates/campaign-details/images/page-top.png') bottom center no-repeat, /* Bottom image */
			url('https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/refs/heads/main/templates/campaign-details/images/page-middle.png') center repeat-y; /* Middle image */
		background-size: contain, contain, auto; /* Sizes for images */
		background-color: #f4f4f4; /* Optional: Fallback background color */
		min-height: 100vh; /* Ensures full viewport height at minimum */
	}
	...
	/* Style for all images except those with alt text "Horizontal Ruler" */
	img:not([alt="Horizontal Ruler"]) {
		display: block;
		margin: 1rem auto;
		max-width: 100%;
	}
