...
var Calendar = Calendar || (function() {
    ...
    checkDefaults = function() {
        ...
        if( ! state.Calendar.now.startdate){state.Calendar.now.startdate = "1,Birch (Hammer),1486"};
    ...
    getMoMenu = function() {
        ...
        switch(world){
            case 1:
                if(leap==0){
                    moMenu = ',?{Month|Birch|Imbolc|Rowan|Ash|Alder|Beltaine|Willow|Hawthorn|Oak|Lughnasa|Holly|Hazel|Ivy|Samhain|Reed|Elder}">';
                }else{
                    moMenu = ',?{Month|Birch|Imbolc|Rowan|Ash|Alder|Beltaine|Aban Artur|Willow|Hawthorn|Oak|Lughnasa|Holly|Hazel|Ivy|Samhain|Reed|Elder}">';
                }
                break;
            case 2:
    ...
    getFaerunArray = function(array) {
        ...
        switch(array) {
            case 'array1':
                moonArray = '0,9,10,10,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,4,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9';
                break;
        case 'array2':
                moonArray = '0,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,14,15,15,16,16,16,0,1,2,2,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9';
                break;
        case 'array3':
                moonArray = '0,9,10,10,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,4,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,14,15,15,16,16,16,1,2,2,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,3,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,11,12,12,13,14,14,15,15,16,16,1,2,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9,10,10,11,11,12,12,13,14,14,15,15,15,16,16,1,2,2,3,3,4,4,5,6,6,7,7,7,8,8,9';
                break;
    ...
    getMoon = function(moonNo) {
        ...
        switch(args) {
            case '1':
                // moon = 'Full Moon';
                moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/full-moon.jpg';
                break;
            case '2':
                // moon = 'Waning Gibbous';
                moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waning-gibbous-moon.jpg';
                break;
            case '3':
                // moon = 'Waning Gibbous';
                moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waning-gibbous-moon.jpg';
            ...
            case '5':
                // moon = 'Last Quarter';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/last-quarter-moon.jpg';
                break;
            case '6':
                // moon = 'Waning Crescent';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waning-crescent-moon.jpg';
                break;
            case '7':
                // moon = 'Waning Crescent';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waning-crescent-moon.jpg';
            ...
            case '9':
                // moon = 'New Moon';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/new-moon.jpg';
                break;
            case '10':
                // moon = 'Waxing Crescent';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waxing-crescent-moon.jpg';
                break;
            case '11':
                // moon = 'Waxing Crescent';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waxing-crescent-moon.jpg';
            ...
            case '13':
                // moon = 'First Quarter';
                moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/first-quarter-moon.jpg';
                break;
            case '14':
                // moon = 'Waxing Gibbous';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waxing-gibbous-moon.jpg';
                break;
            case '15':
                // moon = 'Waxing Gibbous';
            moon = 'https://raw.githubusercontent.com/Tougher-Together-DnD/default-game-assets/main/special-setup/celtic-calendar/images/waxing-gibbous-moon.jpg';
